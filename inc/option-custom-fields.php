...
acf_add_local_field_group(array (
	'key' => 'group_59e76fc0ae781',
	'title' => 'Social Buttons',
	'fields' => array (
		array (
			'key' => 'field_59e76fceed233',
			'label' => 'Social Button Repeater',
			'name' => 'social_button_repeater',
			'type' => 'repeater',
			'instructions' => 'Set the social buttons that should display on the contact page and footer.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
			...
			'sub_fields' => array (
				array (
					'key' => 'field_59e76fd4ed234',
					'label' => 'Social Icon',
					'name' => 'social_icon',
					'type' => 'font-awesome',
					'instructions' => 'Set the social media type',
					'required' => 1,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
				...
				array (
					'key' => 'field_59e7702aed235',
					'label' => 'Social Name',
					'name' => 'social_name',
					'type' => 'text',
					'instructions' => 'Set the social media name (eg. Facebook, Instagram etc.)',
					'required' => 1,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
				...
				array (
					'key' => 'field_59e7704ded236',
					'label' => 'Social Color',
					'name' => 'social_color',
					'type' => 'color_picker',
					'instructions' => 'Set the social media color (check brandcolors.net).',
					'required' => 1,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
				...
				array (
					'key' => 'field_59e7717e8e872',
					'label' => 'Social Link',
					'name' => 'social_link',
					'type' => 'url',
					'instructions' => 'Set the social media link.',
					'required' => 1,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
